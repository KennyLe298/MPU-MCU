...
void writeRows(uint8_t data){
    HAL_GPIO_WritePin(ROW0_GPIO_Port, ROW0_Pin, (data & (1<<0)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW1_GPIO_Port, ROW1_Pin, (data & (1<<1)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW2_GPIO_Port, ROW2_Pin, (data & (1<<2)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW3_GPIO_Port, ROW3_Pin, (data & (1<<3)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW4_GPIO_Port, ROW4_Pin, (data & (1<<4)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW5_GPIO_Port, ROW5_Pin, (data & (1<<5)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW6_GPIO_Port, ROW6_Pin, (data & (1<<6)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(ROW7_GPIO_Port, ROW7_Pin, (data & (1<<7)) ? GPIO_PIN_SET : GPIO_PIN_RESET);
}
